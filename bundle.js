...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  onClickSq: onClickSq,
	  clickCreateGame: clickCreateGame,
	  onSignOut: onSignOut,
	  onSignIn: onSignIn,
	  onSignUp: onSignUp
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changePassword = function changePassword(data) {
	  return $.ajax({
	    ...
	    method: 'PATCH',
	    data: data, //we should also add store.user = null (so the token is no longer stored)
	    headers: {
	...
	var signOut = function signOut() {
	  return (////we should also add store.user = null (so the token is no longer stored)
	    $.ajax({
	...
	module.exports = {
	  signUp: signUp, //makes it available for use
	  signIn: signIn,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateBoard = function updateBoard(index, letter) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameUi = __webpack_require__(12);
	var gameLogic = __webpack_require__(9);
	var store = __webpack_require__(7);
	...
	var onUpdateGame = function onUpdateGame(index, letter) {
	  var data = {
	    "game": {
	      "cell": {
	        "index": index,
	  ...
	  gameApi.updateGame(data).then(gameUi.updateGameSuccess) //changed "create" to "update"
